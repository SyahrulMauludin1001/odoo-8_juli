...
class Biodata(models.Model):
    ...
    custom_many2one_id = fields.Many2one('res.partner', string="1")
    custom_one2many_ids = fields.One2many('res.partner', inverse_name='parent_id', string="2")
    custom_many2many_ids = fields.Many2many('res.partner', string="3")
    custom_one2many_count = fields.Integer(string="4", compute='_count_one2many_items')
